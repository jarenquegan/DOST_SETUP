...
<body class="bg-light" id="page-top">
    ...
    <div class="container-fluid mt-3 bg-custom">
        <h3 class="text-center" style="color: white; padding: 2px;">ACTIVE SETUP PROJECTS</h3>
    </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="example" style="width:100%" class="display compact table table-bordered table-striped table-condensed small">
                        ...
                        <tbody>
                            <?php
                            $tbl_project = $db->display_project_released();
                            $i = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left;" class="content-fit">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li><a href="path_to_attachments/<?php echo htmlspecialchars($attachment['filename'] ?? ''); ?>" download class="dropdown-item small">Download</a></li>
